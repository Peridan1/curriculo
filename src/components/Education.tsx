...
import { SchoolIcon, LocationIcon } from "./icons";
...
export default function Education({ dict }: EducationProps) {
    return (
        <section className="py-24 max-w-300 mx-auto px-6 relative" id="education">
            <div className="flex flex-col items-center text-center mb-16">
                ...
                <div className="w-24 h-1 bg-linear-to-r from-emerald-400 to-cyan-500 rounded-full"></div>
            </div>
                    ...
                    >
                        <div>
                            ...
                            <div className="text-emerald-800 dark:text-emerald-300/90 font-bold text-base mb-4 flex items-center gap-2">
                                <LocationIcon className="size-4 text-cyan-700 dark:text-cyan-400 shrink-0" />
                                {item.institution}
                            </div>
